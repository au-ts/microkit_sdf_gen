...
pub const Gpu = struct {
    ...
    pub fn connectDriver(system: *Gpu) void {
        ...
        const mr_events = Mr.create(allocator, "gpu_driver_events", system.queue_region_size, false, .{});
        ...
        const mr_req = Mr.create(allocator, "gpu_driver_request", system.queue_region_size, false, .{});
        ...
        const mr_resp = Mr.create(allocator, "gpu_driver_response", system.queue_region_size, false, .{});
        ...
        const mr_data = Mr.physical(allocator, sdf, "gpu_driver_data", system.data_region_size, false, .{});
    ...
    pub fn connectClient(system: *Gpu, client: *Pd) void {
        ...
        const mr_events = Mr.create(allocator, fmt(allocator, "gpu_client_{s}_events", .{client.name}), system.queue_region_size, false, .{});
        ...
        const mr_req = Mr.create(allocator, fmt(allocator, "gpu_client_{s}_request", .{client.name}), system.queue_region_size, false, .{});
        ...
        const mr_resp = Mr.create(allocator, fmt(allocator, "gpu_client_{s}_response", .{client.name}), system.queue_region_size, false, .{});
        ...
        const mr_data = Mr.physical(allocator, sdf, fmt(allocator, "gpu_client_{s}_data", .{client.name}), system.data_region_size, false, .{});
