...
pub const Timer = struct {
    ...
    pub fn connect(system: *Timer) !void {
        ...
        if (system.device) | dtb_node | {
            try createDriver(system.sdf, system.driver, dtb_node, .timer, &system.device_res);
        }
...
pub const Serial = struct {
    ...
    pub fn connect(system: *Serial) !void {
        if (system.device) |dtb_node| {
            try createDriver(system.sdf, system.driver, dtb_node, .serial, &system.device_res);
        }
...
pub const Net = struct {
    ...
    pub fn connect(system: *Net) !void {
        if (system.device) |dtb_node| {
            try createDriver(system.sdf, system.driver, dtb_node, .network, &system.device_res);
        }
